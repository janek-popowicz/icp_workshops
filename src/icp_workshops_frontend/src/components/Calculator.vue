...
<template>
  <form class="flex flex-col border-2 p-10 justify-center items-center" action="#" @submit="handleCalculate">
    ...
    <input id="a" v-model.number="a" type="number" placeholder="Numer A" />
    <label for="b">Enter B:</label>
    <input id="b" v-model.number="b" type="number" placeholder="Numer B" />
    ...
    <button type="policz">Calculate</button>
    <p>{{ result }}</p>
  </form>
</template>